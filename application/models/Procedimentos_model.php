...
class Procedimentos_model extends CI_model
{
    ...
    public function porPaciente(array $where = []): array
    {
        ...
        $this->db->join('estabelecimentos', 'procedimentos.estabelecimento_solicitante =  estabelecimentos.estabelecimento_id', 'left');
        $this->db->join('profissionais', 'procedimentos.profissional_solicitante =  profissionais.profissional_id', 'left');
