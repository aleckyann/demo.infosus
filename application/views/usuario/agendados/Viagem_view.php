...
<div class="content mt-3">
            <div class="animated fadeIn"><br>
                <div class="card-title" align="center">
                    <h3 align="center" class="text-center">PACIENTES AGENDADOS (viagem)</h3>
                </div>
                <hr><br>
                <div class="row">
                    <div class="col-md-12">
                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                       ...
                                       <tr>
                                           <td>Jonas Rodrigues Filho</td>
                                           <td>Avenida Padre Horácio Giraldi, 993</td>
                                           <td>(38)9 91752125</td>
                                           <td class="text-center"><button class="btn btn-info"><i class="fa fa-info"></i></button></td>
                                       </tr>

                                       <tr>
                                           <td>Heitor Rodrigues Bikes</td>
                                           <td>Rua das Pedras, 24</td>
                                           <td>(38)9 98827266</td>
                                           <td class="text-center"><button class="btn btn-info"><i class="fa fa-info"></i></button></td>
                                       </tr>
