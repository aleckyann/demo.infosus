            ...
            <div class="card-body card-block">
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" id="company" value="<?= $veiculo_dados['tipo'].' - '.$veiculo_dados['lugares'] ?> LUGARES" class="form-control" disabled>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="vat" class=" form-control-label">MARCA</label>
                        <input type="text" id="vat" value="<?= @$veiculo_dados['marca'] ?>" class="form-control" disabled>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="street" class=" form-control-label">PLACA</label>
                        <input type="text" id="street" class="form-control" value="<?= $veiculo_dados['placa'] ?>" disabled>
                    </div>
             
                    <div class="form-group col-md-6">
                        <label for="country" class=" form-control-label">ANO</label>
                        <input type="text" id="country"  class="form-control" value="<?= $veiculo_dados['ano'] ?>" disabled>
                    </div>
                </div>
            </div>
        </div>
