...
<div class="modal fade" id="add_especialidade_conf_modal" role="dialog" aria-labelledby="add_especialidade_label" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('v2/configuracoes/especialidades/novo') ?>" id="add_especialidade_conf_form" method="post">
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-primary btn-sm" id="add_especialidades_conf_submit_button" type="submit">Adicionar</button>
                </div>
            </form>
        </div>
    </div>
