...
<div class="modal fade" id="add_usuario_conf_modal" tabindex="-1" role="dialog" aria-labelledby="add_usuario_conf_label" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('v2/configuracoes/usuarios/novo') ?>" id="add_usuario_conf_form" method="post">
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-primary btn-sm" id="add_usuario_conf_submit_button" type="submit">Adicionar</button>
                </div>
            </form>
        </div>
    </div>
