<!-- Modal editar_procedimento_agendado_modal-->
<div class="modal fade" id="editar_procedimento_agendado_modal" role="dialog" aria-labelledby="editar_procedimento_label" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-warning">
                <h5 class="modal-title font-weight-light text-white" id="editar_procedimento_label"><i class="fas fa-edit"></i> Editar procedimento agendado</h5><button class=" btn-close" type="button" data-dismiss="modal" aria-label="Close"></button>
            </div>
