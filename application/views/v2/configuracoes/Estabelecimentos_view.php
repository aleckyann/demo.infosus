    ...
    <div class="card overflow-hidden flex-1">
        ...
        <div class="card-body position-relative">
            ...
            <h4 class="font-weight-light">
                ...
                <i class="fas fa-user-edit"></i> Estabelecimentos
                <!-- <span class="badge badge-soft-warning rounded-pill ml-2">-0.23%</span> -->
            </h4>
            <div class="collapse" id="collapseExample">
                <div class="p-card">
                    <p class="mb-2">
                        Nesta página você pode configurar os estabelecimentos cadastrados no sistema
                    </p>
                </div>
            </div>
        </div>
...
<?php $this->load->view('v2/components/configuracoes/add_estabelecimento_conf_modal') ?>

<script>
    window.onload = function() {

        // SET LOADING BUTTONS
        $('#add_estabelecimento_conf_form').on('submit', function() {
            $('#add_estabelecimento_conf_submit_button').html(`
        ...
        $('#estabelecimentos_conf_datatable thead th').each(function() {
            let title = $(this).text();
        ...
        $('#estabelecimentos_conf_datatable').DataTable({
