    ...
    <div class="card overflow-hidden flex-1">
        ...
        <div class="card-body position-relative">
            ...
            <h4 class="font-weight-light">
                ...
                <i class="fas fa-user-edit"></i> Municípios
                <!-- <span class="badge badge-soft-warning rounded-pill ml-2">-0.23%</span> -->
            </h4>
            <div class="collapse" id="collapseExample">
                <div class="p-card">
                    <p class="mb-2">
                        Nesta página você pode configurar os municípios cadastrados no sistema
                    </p>
                </div>
            </div>
        </div>
...
<div class="card mb-3">
    ...
    <div class="card-body">
        <table id="municipio_conf_datatable" class="table table-striped" style="min-height: 200px;">
            <thead>
                <th class="text-dark small text-left">MUNICÍPIOS</th>
                <th class="text-dark small text-left">CÓDIGO IBGE</th>
            </thead>
            <tbody>
...
<?php $this->load->view('v2/components/configuracoes/add_municipio_conf_modal') ?>

<script>
    window.onload = function() {

        // SET LOADING BUTTONS
        $('#add_municipio_conf_form').on('submit', function() {
            $('#add_municipio_conf_submit_button').html(`
        ...
        $('#municipio_conf_datatable thead th').each(function() {
            let title = $(this).text();
        ...
        $('#municipio_conf_datatable').DataTable({
