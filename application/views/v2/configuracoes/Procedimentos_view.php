    ...
    <div class="card overflow-hidden flex-1">
        ...
        <div class="card-body position-relative">
            ...
            <div class="collapse" id="collapseExample">
                <div class="p-card">
                    <p class="mb-2">
                        Nesta página você pode configurar os procedimentos cadastrados no sistema
                    </p>
                </div>
            </div>
        </div>
...
<div class="card mb-3">
    ...
    <div class="card-body">
        <table id="procedimentos_conf_datatable" class="table table-striped" style="min-height: 200px;">
            <thead>
                <th class="text-dark small text-left">PROCEDIMENTO</th>
                <th class="text-dark small text-left">CÓDIGO</th>
            </thead>
            <tbody>
...
<?php $this->load->view('v2/components/configuracoes/add_procedimento_conf_modal') ?>
...
<script>
    window.onload = function() {
        ...
        $('#procedimentos_conf_datatable thead th').each(function() {
            let title = $(this).text();
        ...
        $('#procedimentos_conf_datatable').DataTable({
