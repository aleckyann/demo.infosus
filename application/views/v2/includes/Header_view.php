                ...
                <div class="collapse navbar-collapse" id="navbarVerticalCollapse">
                    <div class="navbar-vertical-content scrollbar">
                        ...
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link dropdown-indicator <?= (segment(2) == 'pacientes') ? 'active' : '' ?>" href="#atencaoNav" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="atencaoNav">
                                    <div class="d-flex align-items-center">
                                ...
                                <ul class="nav collapse <?= (segment(2) == 'pacientes') ? 'show' : '' ?>" id="atencaoNav" data-parent="#navbarVerticalCollapse">
                                    <li class="nav-item"><a class="nav-link <?= (segment(3) == 'listagem') ? 'active' : '' ?>" href="<?= base_url('v2/pacientes/listagem') ?>"><i class="fas fa-clipboard-list mr-1"></i> ...</a></li>
                                    <li class="nav-item"><a class="nav-link" href="#" data-toggle="modal" data-target="#add_paciente_modal"><i class=" fas fa-user-plus"></i> ...</a></li>
                                </ul>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link dropdown-indicator <?= (segment(2) == 'pacientes') ? 'active' : '' ?>" href="#almoxarifadoNav" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="almoxarifadoNav">
                                    <div class="d-flex align-items-center">
