    ...
    <div class="card overflow-hidden flex-1">
        ...
        <div class="card-body position-relative">
            ...
            <h3 class="font-weight-light">
                ...
                <i class="fas fa-route text-danger"></i> Viagens canceladas
                <!-- <span class="badge badge-soft-warning rounded-pill ml-2">-0.23%</span> -->
            </h3>
            <div class="collapse" id="collapseExample">
                <div class="p-card">
                    <p class="mb-2">
                        Nesta página você pode visualizar todas as viagens canceladas.
                    </p>
                </div>
            </div>
        </div>
...
<div class="card mb-3">
    ...
    <div class="card-body">
        <table id="viagens_canceladas_datatable" class="table table-striped table-hover" style="min-height: 200px;">
            <thead>
...
<script>
    window.onload = function() {
        ...
        $('#viagens_canceladas_datatable').DataTable({
