...
var kanbanInit = function kanbanInit() {
  ...
  addCardButtons && addCardButtons.forEach(function (button) {
    button.addEventListener(Events.CLICK, function (_ref3) {
  ...
  if (addListForm) {
    ...
    addListForm.addEventListener(Events.SHOW_BS_COLLAPSE, function (_ref5) {
    ...
    addListForm.addEventListener(Events.SHOWN_BS_COLLAPSE, function (_ref6) {
...
var searchInit = function searchInit() {
  ...
  searchAreas.forEach(function (searchArea) {
    ...
    document.addEventListener(Events.CLICK, function (_ref8) {
  ...
  if (window.tinymce) {
    ...
    if (tinymces.length) {
      window.tinymce.init({
        ...
        content_style: ".mce-content-body { color: ".concat(utils.grays.black, " }"),
        mobile: {
          theme: 'mobile',
          toolbar: ['undo', 'bold']
        },
...
var appCalendarInit = function appCalendarInit() {
  ...
  addEventModal && addEventModal.addEventListener(Events.SHOWN_BS_MODAL, function (_ref9) {
...
var totalSales = function totalSales() {
  ...
  if ($echartsLineTotalSales) {
    ...
    chart.setOption(options); // Change chart options accordiong to the selected month
